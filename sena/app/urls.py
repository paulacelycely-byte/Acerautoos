...
urlpatterns = [
    ...
    path('editar_productos/<int:pk>/',
         ProductosUpdateView.as_view(), name='editar_productos'),
    path('eliminar_productos/<int:pk>/',
         ProductosDeleteView.as_view(), name='eliminar_productos'),
    ...
    path('editar_vehiculo/<int:pk>/',
         VehiculoUpdateView.as_view(), name='editar_vehiculo'),
    path('eliminar_vehiculo/<int:pk>/',
    ...
    #  ENTRADA VEHÍCULO
    path('listar_entrada_vehiculo/', Entrada_vehiculoListView.as_view(),
         name='listar_entrada_vehiculo'),
    path('crear_entrada_vehiculo/', Entrada_vehiculoCreateViews.as_view(),
         name='crear_entrada_vehiculo'),
    path('editar_entrada_vehiculo/<int:pk>/',
         Entrada_vehiculoUpdateView.as_view(), name='editar_entrada_vehiculo'),
    path('eliminar_entrada_vehiculo/<int:pk>/',
         EntradaVehiculoDeleteView.as_view(), name='eliminar_entrada_vehiculo'),

    #  Ventas
    path('listar_Ventas/', VentasListView.as_view(), name='listar_Ventas'),
    path('crear_Ventas/', VentasCreateView.as_view(), name='crear_Ventas'),
    path('editar_Ventas/<int:pk>/',
         VentasUpdateView.as_view(), name='editar_Ventas'),
    path('eliminar_Ventas/<int:pk>/',
         Ventas_delete.as_view(), name='eliminar_Ventas'),
    ...
    path('proveedores/listar/', ProveedorListView.as_view(),
    ...
    # --- MÓDULO DE SERVICIOS ---
    path('tipo_servicio/listar/',
         TipoServicioListView.as_view(), name='listar_servicio'),
    path('tipo_servicio/crear/',
         TipoServicioCreateView.as_view(), name='crear_servicio'),
    path('tipo_servicio/editar/<int:pk>/',
         TipoServicioUpdateView.as_view(), name='editar_servicio'),
    path('tipo_servicio/eliminar/<int:pk>/',
         TipoServicioDeleteView.as_view(), name='eliminar_servicio'),
    ...
    path('compra/editar/<int:pk>/',
         CompraUpdateView.as_view(), name='editar_compra'),
    path('compra/eliminar/<int:pk>/',
         CompraDeleteView.as_view(), name='eliminar_compra'),
    # --- MÓDULO DE FACTURAS (SOLO CONSULTA) ---
    path('factura/listar/', FacturaListView.as_view(), name='listar_facturas'),
    path('factura/detalle/<int:pk>/',
         FacturaDetailView.as_view(), name='detalle_factura'),
    # --- MÓDULO DE LOGIN ---
    # path('acceso/', include(('login.urls', 'login'), namespace='login')),
    # ===== SALIDA VEHÍCULO =====
    path('listar_salida_vehiculo/', Salida_vehiculoListView.as_view(),
         name='listar_salida_vehiculo'),
    path('crear_salida_vehiculo/', Salida_vehiculoCreateView.as_view(),
         name='crear_salida_vehiculo'),
    path('editar_salida_vehiculo/<int:pk>/',
         Salida_vehiculoUpdateView.as_view(), name='editar_salida_vehiculo'),
    path('eliminar_salida_vehiculo/<int:pk>/',
         Salida_vehiculoDeleteView.as_view(), name='eliminar_salida_vehiculo'),


    # ===== INSUMOS =====
    path('listar_insumo/', InsumoListView.as_view(), name='listar_insumo'),
    path('crear_insumo/', InsumoCreateView.as_view(), name='crear_insumo'),
    path('editar_insumo/<int:pk>/',
         InsumoUpdateView.as_view(), name='editar_insumo'),
    path('eliminar_insumo/<int:pk>/',
         InsumoDeleteView.as_view(), name='eliminar_insumo'),
    ...
    path('editar_servicio/<int:pk>/',
         ServicioUpdateView.as_view(), name='editar_servicio'),
    path('eliminar_servicio/<int:pk>/',
         ServicioDeleteView.as_view(), name='eliminar_servicio'),
