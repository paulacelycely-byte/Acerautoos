...
from .views.UsuarioSistema         import views as vistas_usr    # antes: Usuario
from .views.Empleado               import views as vistas_emp    # nuevo: directorio personal
...
from .views.backup import views as vistas_backup
...
urlpatterns = [
    ...
    # --- EMPLEADOS ---
    path('empleados/listar/',            vistas_emp.EmpleadoListView.as_view(),   name='listar_empleado'),
    path('empleados/crear/',             vistas_emp.EmpleadoCreateView.as_view(), name='crear_empleado'),
    path('empleados/editar/<int:pk>/',   vistas_emp.EmpleadoUpdateView.as_view(), name='editar_empleado'),
    path('empleados/eliminar/<int:pk>/', vistas_emp.EmpleadoDeleteView.as_view(), name='eliminar_empleado'),
    ...
    path('notificaciones/marcar-leida/<int:pk>/', vistas_notif.MarcarLeidaView.as_view(),      name='marcar_notificacion_leida'),
    path('notificaciones/marcar-todas-leidas/',   vistas_notif.MarcarTodasLeidasView.as_view(), name='marcar_todas_leidas'),
    ...
    path('orden_servicio/detalle/<int:pk>/',  vistas_orden.OrdenServicioDetailView.as_view(), name='orden_servicio_detail'),
    ...
    path('reportes/facturas/excel/',    vistas_rep.ExportarFacturasExcel.as_view(),    name='reporte_facturas_excel'),
     # --- backup ---
    path('backup/', vistas_backup.backup, name='backup'),
    path('backup/restaurar/', vistas_backup.restaurar_datos, name='restaurar_datos'),
]