...
class TipoServicioListView(ListView): 
    ...
    def get_context_data(self, **kwargs):
        ...
        context['crear_url'] = reverse_lazy('app:crear_tipo_servicio') 
        return context
...
class TipoServicioCreateView(CreateView):
    ...
    success_url = reverse_lazy('app:listar_tipo_servicio') 
    
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['titulo'] = 'Crear Tipo de Servicio'
        context['listar_url'] = reverse_lazy('app:listar_tipo_servicio')
        return context
